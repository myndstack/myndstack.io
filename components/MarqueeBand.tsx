...
export default function MarqueeBand() {
  return (
    ...
    >
      <MarqueeTrack className="animate-marq hover:[animation-play-state:paused] flex w-max gap-11 font-display text-56 leading-none font-bold tracking-display whitespace-nowrap sm:text-marquee">
        {[0, 1, 2, 3].map((i) => (
