...
export default function MarqueeBand() {
  return (
    ...
    >
      <MarqueeTrack className="animate-marq hover:[animation-play-state:paused] flex w-max gap-11 font-display text-[60px] leading-[0.9] font-bold tracking-[-0.035em] whitespace-nowrap sm:text-[112px]">
        {[0, 1, 2, 3].map((i) => (
