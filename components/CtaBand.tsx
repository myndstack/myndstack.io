  ...
  return (
    <section id="cta" className="mx-auto mt-[60px] max-w-[1200px] px-5 sm:px-14">
      <Reveal className="clip-angular-40 relative overflow-hidden bg-lime px-6 py-[72px] text-center sm:px-14">
        <div className="mb-[18px] font-mono text-12 font-bold tracking-[0.16em] text-lime-ink-2 uppercase">
          Start building
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-3.5">
          <Magnetic>
            <a
              href="#contact"
              className="btn bg-lime-ink px-7 text-15 text-lime hover:bg-ink hover:text-lime"
            >
              Start a project →
            </a>
          </Magnetic>
          <Magnetic>
            <a
              href="#pricing"
              className="btn border border-lime-ink/35 bg-transparent px-7 text-15 text-lime-ink hover:bg-lime-ink/8 hover:text-lime-ink"
            >
              See pricing
            </a>
          </Magnetic>
