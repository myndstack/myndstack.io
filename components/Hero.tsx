  ...
  return (
    ...
    >
      ...
      <div className="relative z-2 flex flex-1 flex-col items-center justify-center px-5 pt-[calc(60px+var(--nav-height))] pb-[60px] text-center sm:px-16">
        ...
        <h1 className="animate-rise-in m-0 max-w-[1000px] font-display text-[clamp(42px,7.2vw,92px)] leading-none font-normal tracking-[-0.03em] text-balance [animation-duration:0.7s]">
          {WORDS.map((word, i) => (
            <span key={word}>
